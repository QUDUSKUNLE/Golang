...
type ShippingServiceClient interface {
	Create(ctx context.Context, in *CreateShippingRequest, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *shippingServiceClient) Create(ctx context.Context, in *CreateShippingRequest, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
...
type ShippingServiceServer interface {
	Create(context.Context, *CreateShippingRequest) (*Response, error)
...
func (UnimplementedShippingServiceServer) Create(context.Context, *CreateShippingRequest) (*Response, error) {
