...
type ScheduleRequest struct {
	...
	Date               string        `protobuf:"bytes,2,opt,name=date,proto3" json:"date,omitempty"`                                                         // Date of the session (e.g., "2025-05-01")
	Time               string        `protobuf:"bytes,3,opt,name=time,proto3" json:"time,omitempty"`                                                         // Time of the session (e.g., "10:00 AM")
	TestType           SessionType   `protobuf:"varint,4,opt,name=test_type,json=testType,proto3,enum=SessionType" json:"test_type,omitempty"`               // Type of diagnostic test
	Status             SessionStatus `protobuf:"varint,5,opt,name=status,proto3,enum=SessionStatus" json:"status,omitempty"`
	Notes              string        `protobuf:"bytes,6,opt,name=notes,proto3" json:"notes,omitempty"` // Status of the session              // Additional notes (optional)
}
...
type UpdateScheduledSessionRequest struct {
	...
	ScheduleId         string        `protobuf:"bytes,1,opt,name=schedule_id,json=scheduleId,proto3" json:"schedule_id,omitempty"`                           // ID of the scheduled session             // ID of the user scheduling the session
	DiagnosticCentreId string        `protobuf:"bytes,2,opt,name=diagnostic_centre_id,json=diagnosticCentreId,proto3" json:"diagnostic_centre_id,omitempty"` // ID of the diagnostic center
	...
	Notes              string        `protobuf:"bytes,7,opt,name=notes,proto3" json:"notes,omitempty"` // Status of the session              // Additional notes (optional)
}
...
type CancelScheduledSessionRequest struct {
	...
	ScheduleId string        `protobuf:"bytes,1,opt,name=schedule_id,json=scheduleId,proto3" json:"schedule_id,omitempty"` // ID of the scheduled session// ID of the user canceling the session
	Status     SessionStatus `protobuf:"varint,2,opt,name=status,proto3,enum=SessionStatus" json:"status,omitempty"`       // Status of the session
}
...
type GetScheduledSessionResponse struct {
	...
	Notes              string `protobuf:"bytes,8,opt,name=notes,proto3" json:"notes,omitempty"`                           // Status of the session             // Additional notes (optional)
...
var file_schedule_schedule_proto_rawDesc = []byte{
	...
	0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xd4, 0x01, 0x0a, 0x0f, 0x53, 0x63, 0x68, 0x65,
	...
	0x6f, 0x73, 0x74, 0x69, 0x63, 0x43, 0x65, 0x6e, 0x74, 0x72, 0x65, 0x49, 0x64, 0x12, 0x12, 0x0a,
	...
	0x04, 0x74, 0x69, 0x6d, 0x65, 0x12, 0x29, 0x0a, 0x09, 0x74, 0x65, 0x73, 0x74, 0x5f, 0x74, 0x79,
	0x70, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x0c, 0x2e, 0x53, 0x65, 0x73, 0x73, 0x69,
	0x6f, 0x6e, 0x54, 0x79, 0x70, 0x65, 0x52, 0x08, 0x74, 0x65, 0x73, 0x74, 0x54, 0x79, 0x70, 0x65,
	...
	0x73, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x6e, 0x6f, 0x74, 0x65, 0x73, 0x22, 0x3d,
	0x0a, 0x1a, 0x47, 0x65, 0x74, 0x53, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x65, 0x64, 0x53, 0x65,
	...
	0x09, 0x52, 0x0a, 0x73, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x65, 0x49, 0x64, 0x22, 0x83, 0x02,
	0x0a, 0x1d, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x53, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x65,
	...
	0x65, 0x6e, 0x74, 0x72, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x12,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x74, 0x69, 0x6d, 0x65, 0x12, 0x29, 0x0a, 0x09, 0x74, 0x65,
	0x73, 0x74, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x0c, 0x2e,
	0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x54, 0x79, 0x70, 0x65, 0x52, 0x08, 0x74, 0x65, 0x73,
	0x74, 0x54, 0x79, 0x70, 0x65, 0x12, 0x26, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18,
	0x06, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x0e, 0x2e, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x53,
	...
	0x74, 0x65, 0x73, 0x22, 0x68, 0x0a, 0x1d, 0x43, 0x61, 0x6e, 0x63, 0x65, 0x6c, 0x53, 0x63, 0x68,
	...
	0x75, 0x6c, 0x65, 0x49, 0x64, 0x12, 0x26, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x0e, 0x2e, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x53,
	0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0x1e, 0x0a,
	0x1c, 0x4c, 0x69, 0x73, 0x74, 0x53, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x65, 0x64, 0x53, 0x65,
	0x73, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0xbb, 0x02,
	0x0a, 0x1b, 0x47, 0x65, 0x74, 0x53, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x65, 0x64, 0x53, 0x65,
	...
	0x6d, 0x65, 0x12, 0x1b, 0x0a, 0x09, 0x74, 0x65, 0x73, 0x74, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18,
	0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x74, 0x65, 0x73, 0x74, 0x54, 0x79, 0x70, 0x65, 0x12,
	...
	0x18, 0x08, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x6e, 0x6f, 0x74, 0x65, 0x73, 0x12, 0x1d, 0x0a,
	...
	0x52, 0x09, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x22, 0xaf, 0x02, 0x0a, 0x10,
	...
	0x74, 0x69, 0x6d, 0x65, 0x12, 0x1b, 0x0a, 0x09, 0x74, 0x65, 0x73, 0x74, 0x5f, 0x74, 0x79, 0x70,
	0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x74, 0x65, 0x73, 0x74, 0x54, 0x79, 0x70,
	...
	0x28, 0x09, 0x52, 0x09, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x22, 0x4e, 0x0a,
	0x1d, 0x4c, 0x69, 0x73, 0x74, 0x53, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x65, 0x64, 0x53, 0x65,
	...
	0x32, 0x11, 0x2e, 0x53, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x65, 0x64, 0x53, 0x65, 0x73, 0x73,
	0x69, 0x6f, 0x6e, 0x52, 0x08, 0x73, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0xb2, 0x01,
	...
	0x41, 0x74, 0x22, 0x74, 0x0a, 0x1e, 0x43, 0x61, 0x6e, 0x63, 0x65, 0x6c, 0x53, 0x63, 0x68, 0x65,
	...
	0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x66, 0x0a, 0x10, 0x53, 0x63, 0x68, 0x65,
	...
	0x2a, 0x5b, 0x0a, 0x0d, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x53, 0x74, 0x61, 0x74, 0x75,
	...
	,
	...
	,
	...
	,
	...
	0x6c, 0x65, 0x5f, 0x69, 0x64, 0x7d, 0x12, 0x80, 0x01, 0x0a, 0x15, 0x55, 0x70, 0x64, 0x61, 0x74,
	0x65, 0x53, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x65, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e,
	0x12, 0x1e, 0x2e, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x53, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c,
	0x65, 0x64, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x1a, 0x1f, 0x2e, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x53, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c,
	0x65, 0x64, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73,
	...
	0x65, 0x64, 0x75, 0x6c, 0x65, 0x5f, 0x69, 0x64, 0x7d, 0x12, 0x7d, 0x0a, 0x15, 0x43, 0x61, 0x6e,
	0x63, 0x65, 0x6c, 0x53, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x65, 0x53, 0x65, 0x73, 0x73, 0x69,
	0x6f, 0x6e, 0x12, 0x1e, 0x2e, 0x43, 0x61, 0x6e, 0x63, 0x65, 0x6c, 0x53, 0x63, 0x68, 0x65, 0x64,
	0x75, 0x6c, 0x65, 0x64, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x1a, 0x1f, 0x2e, 0x43, 0x61, 0x6e, 0x63, 0x65, 0x6c, 0x53, 0x63, 0x68, 0x65, 0x64,
	0x75, 0x6c, 0x65, 0x64, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f,
	...
	,
...
var file_schedule_schedule_proto_goTypes = []interface{}{
	...
	(*GetScheduledSessionRequest)(nil),     // 7: GetScheduledSessionRequest
	(*UpdateScheduledSessionRequest)(nil),  // 8: UpdateScheduledSessionRequest
	(*CancelScheduledSessionRequest)(nil),  // 9: CancelScheduledSessionRequest
	(*ListScheduledSessionsRequest)(nil),   // 10: ListScheduledSessionsRequest
	(*GetScheduledSessionResponse)(nil),    // 11: GetScheduledSessionResponse
	(*ScheduledSession)(nil),               // 12: ScheduledSession
	(*ListScheduledSessionsResponse)(nil),  // 13: ListScheduledSessionsResponse
...
var file_schedule_schedule_proto_depIdxs = []int32{
	...
	1,  // 2: UpdateScheduledSessionRequest.test_type:type_name -> SessionType
	0,  // 3: UpdateScheduledSessionRequest.status:type_name -> SessionStatus
	0,  // 4: CancelScheduledSessionRequest.status:type_name -> SessionStatus
	12, // 5: ListScheduledSessionsResponse.sessions:type_name -> ScheduledSession
	6,  // 6: ScheduleService.CreateScheduleSession:input_type -> ScheduleRequest
	7,  // 7: ScheduleService.GetScheduleSession:input_type -> GetScheduledSessionRequest
	8,  // 8: ScheduleService.UpdateScheduleSession:input_type -> UpdateScheduledSessionRequest
	9,  // 9: ScheduleService.CancelScheduleSession:input_type -> CancelScheduledSessionRequest
	10, // 10: ScheduleService.ListScheduleSessions:input_type -> ListScheduledSessionsRequest
	16, // 11: ScheduleService.CreateScheduleSession:output_type -> ScheduleResponse
	11, // 12: ScheduleService.GetScheduleSession:output_type -> GetScheduledSessionResponse
	14, // 13: ScheduleService.UpdateScheduleSession:output_type -> UpdateScheduledSessionResponse
	15, // 14: ScheduleService.CancelScheduleSession:output_type -> CancelScheduledSessionResponse
	13, // 15: ScheduleService.ListScheduleSessions:output_type -> ListScheduledSessionsResponse
