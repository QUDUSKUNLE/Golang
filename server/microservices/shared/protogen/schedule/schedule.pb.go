...
const (
	TestStatus_TEST_STATUS_UNSPECIFIED TestStatus = 0 // For SessionStatus
	TestStatus_SCHEDULED               TestStatus = 1 // Session is scheduled
	TestStatus_COMPLETED               TestStatus = 2 // Session is completed
	TestStatus_CANCELED                TestStatus = 3 // Session is canceled
)
...
const (
	...
	TestType_BLOOD_TEST            TestType = 1  // Blood test
	TestType_URINE_TEST            TestType = 2  // Urine test
	TestType_X_RAY                 TestType = 3  // X-ray
	TestType_MRI                   TestType = 4  // MRI
	TestType_CT_SCAN               TestType = 5  // CT scan
	TestType_ULTRASOUND            TestType = 6  // Ultrasound
	TestType_ECG                   TestType = 7  // Electrocardiogram
	TestType_COVID_TEST            TestType = 8  // COVID-19 test
	TestType_DNA_TEST              TestType = 9  // DNA test
	TestType_ALLERGY_TEST          TestType = 10 // Allergy test
	TestType_GENETIC_TEST          TestType = 11 // Genetic test
	TestType_OTHER                 TestType = 12 // Other types of tests
)
...
type ScheduleRequest struct {
	...
	TestType           TestType   `protobuf:"varint,5,opt,name=test_type,json=testType,proto3,enum=TestType" json:"test_type,omitempty"` // Type of diagnostic test
	TestStatus         TestStatus `protobuf:"varint,6,opt,name=test_status,json=testStatus,proto3,enum=TestStatus" json:"test_status,omitempty"`
...
func (x *ScheduleRequest) GetTestType() TestType {
	if x != nil {
		return x.TestType
	}
...
func (x *ScheduleRequest) GetTestStatus() TestStatus {
	if x != nil {
		return x.TestStatus
	}
...
type ListDiagnosticCentreSchedulesRequest struct {
	...
	TestStatus         TestStatus `protobuf:"varint,2,opt,name=test_status,json=testStatus,proto3,enum=TestStatus" json:"test_status,omitempty"`
...
func (x *ListDiagnosticCentreSchedulesRequest) GetTestStatus() TestStatus {
	if x != nil {
		return x.TestStatus
	}
	return TestStatus_TEST_STATUS_UNSPECIFIED
...
type UpdateScheduledSessionRequest struct {
	...
	TestType           TestType   `protobuf:"varint,6,opt,name=test_type,json=testType,proto3,enum=TestType" json:"test_type,omitempty"`                  // Type of diagnostic test
	TestStatus         TestStatus `protobuf:"varint,7,opt,name=test_status,json=testStatus,proto3,enum=TestStatus" json:"test_status,omitempty"`
...
func (x *UpdateScheduledSessionRequest) GetTestType() TestType {
	if x != nil {
		return x.TestType
	}
	return TestType_TEST_TYPE_UNSPECIFIED
...
func (x *UpdateScheduledSessionRequest) GetTestStatus() TestStatus {
	if x != nil {
		return x.TestStatus
	}
	return TestStatus_TEST_STATUS_UNSPECIFIED
...
type CancelScheduledSessionRequest struct {
	...
	TestStatus TestStatus `protobuf:"varint,3,opt,name=test_status,json=testStatus,proto3,enum=TestStatus" json:"test_status,omitempty"` // Status of the session
}
...
func (x *CancelScheduledSessionRequest) GetTestStatus() TestStatus {
	if x != nil {
		return x.TestStatus
	}
	return TestStatus_TEST_STATUS_UNSPECIFIED
...
func (x *GetScheduledSessionResponse) GetTestType() TestType {
	if x != nil {
		return x.TestType
	}
	return TestType_TEST_TYPE_UNSPECIFIED
...
func (x *GetScheduledSessionResponse) GetTestStatus() TestStatus {
	if x != nil {
		return x.TestStatus
	}
	return TestStatus_TEST_STATUS_UNSPECIFIED
...
type GetDiagnosticCentreScheduleResponse struct {
	...
	Time               string     `protobuf:"bytes,5,opt,name=time,proto3" json:"time,omitempty"`                                                         // Time of the session (e.g., "10:00 AM")
	TestType           TestType   `protobuf:"varint,6,opt,name=test_type,json=testType,proto3,enum=TestType" json:"test_type,omitempty"`                  // Type of diagnostic test
	TestStatus         TestStatus `protobuf:"varint,7,opt,name=test_status,json=testStatus,proto3,enum=TestStatus" json:"test_status,omitempty"`          // Type of diagnostic test
...
func (x *GetDiagnosticCentreScheduleResponse) GetTestType() TestType {
	if x != nil {
		return x.TestType
	}
	return TestType_TEST_TYPE_UNSPECIFIED
...
func (x *GetDiagnosticCentreScheduleResponse) GetTestStatus() TestStatus {
	if x != nil {
		return x.TestStatus
	}
	return TestStatus_TEST_STATUS_UNSPECIFIED
...
func (x *ScheduledSession) GetTestType() TestType {
	if x != nil {
		return x.TestType
	}
	return TestType_TEST_TYPE_UNSPECIFIED
...
func (x *ScheduledSession) GetTestStatus() TestStatus {
	if x != nil {
		return x.TestStatus
	}
	return TestStatus_TEST_STATUS_UNSPECIFIED
...
var file_schedule_schedule_proto_rawDesc = []byte{
	...
	0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xff, 0x01, 0x0a, 0x0f, 0x53, 0x63, 0x68, 0x65,
	...
	,
	...
	0x73, 0x74, 0x12, 0x30, 0x0a, 0x14, 0x64, 0x69, 0x61, 0x67, 0x6e, 0x6f, 0x73, 0x74, 0x69, 0x63,
	0x5f, 0x63, 0x65, 0x6e, 0x74, 0x72, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x12, 0x64, 0x69, 0x61, 0x67, 0x6e, 0x6f, 0x73, 0x74, 0x69, 0x63, 0x43, 0x65, 0x6e, 0x74,
	0x72, 0x65, 0x49, 0x64, 0x12, 0x2c, 0x0a, 0x0b, 0x74, 0x65, 0x73, 0x74, 0x5f, 0x73, 0x74, 0x61,
	0x74, 0x75, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x0b, 0x2e, 0x54, 0x65, 0x73, 0x74,
	0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x0a, 0x74, 0x65, 0x73, 0x74, 0x53, 0x74, 0x61, 0x74,
	0x75, 0x73, 0x12, 0x12, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09,
	...
	,
	...
	0x73, 0x65, 0x72, 0x49, 0x64, 0x22, 0xae, 0x02, 0x0a, 0x1d, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65,
	...
	0x64, 0x12, 0x30, 0x0a, 0x14, 0x64, 0x69, 0x61, 0x67, 0x6e, 0x6f, 0x73, 0x74, 0x69, 0x63, 0x5f,
	0x63, 0x65, 0x6e, 0x74, 0x72, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52,
	...
	,
	...
	0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x65, 0x49, 0x64, 0x12, 0x17, 0x0a, 0x07, 0x75, 0x73, 0x65,
	0x72, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x75, 0x73, 0x65, 0x72,
	0x49, 0x64, 0x12, 0x2c, 0x0a, 0x0b, 0x74, 0x65, 0x73, 0x74, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x75,
	0x73, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x0b, 0x2e, 0x54, 0x65, 0x73, 0x74, 0x53, 0x74,
	0x61, 0x74, 0x75, 0x73, 0x52, 0x0a, 0x74, 0x65, 0x73, 0x74, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73,
	0x22, 0x65, 0x0a, 0x1c, 0x4c, 0x69, 0x73, 0x74, 0x53, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x65,
	...
	,
	...
	0x6e, 0x6f, 0x74, 0x65, 0x73, 0x22, 0xf2, 0x02, 0x0a, 0x23, 0x47, 0x65, 0x74, 0x44, 0x69, 0x61,
	0x67, 0x6e, 0x6f, 0x73, 0x74, 0x69, 0x63, 0x43, 0x65, 0x6e, 0x74, 0x72, 0x65, 0x53, 0x63, 0x68,
	0x65, 0x64, 0x75, 0x6c, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x1f, 0x0a,
	...
	0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x12, 0x30, 0x0a, 0x14, 0x64, 0x69, 0x61, 0x67, 0x6e,
	0x6f, 0x73, 0x74, 0x69, 0x63, 0x5f, 0x63, 0x65, 0x6e, 0x74, 0x72, 0x65, 0x5f, 0x69, 0x64, 0x18,
	0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x12, 0x64, 0x69, 0x61, 0x67, 0x6e, 0x6f, 0x73, 0x74, 0x69,
	0x63, 0x43, 0x65, 0x6e, 0x74, 0x72, 0x65, 0x49, 0x64, 0x12, 0x12, 0x0a, 0x04, 0x64, 0x61, 0x74,
	...
	0x65, 0x12, 0x26, 0x0a, 0x09, 0x74, 0x65, 0x73, 0x74, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x06,
	0x20, 0x01, 0x28, 0x0e, 0x32, 0x09, 0x2e, 0x54, 0x65, 0x73, 0x74, 0x54, 0x79, 0x70, 0x65, 0x52,
	0x08, 0x74, 0x65, 0x73, 0x74, 0x54, 0x79, 0x70, 0x65, 0x12, 0x2c, 0x0a, 0x0b, 0x74, 0x65, 0x73,
	0x74, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x0b,
	0x2e, 0x54, 0x65, 0x73, 0x74, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x0a, 0x74, 0x65, 0x73,
	0x74, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x19, 0x0a, 0x05, 0x6e, 0x6f, 0x74, 0x65, 0x73,
	0x18, 0x08, 0x20, 0x01, 0x28, 0x09, 0x48, 0x00, 0x52, 0x05, 0x6e, 0x6f, 0x74, 0x65, 0x73, 0x88,
	...
	0x42, 0x08, 0x0a, 0x06, 0x5f, 0x6e, 0x6f, 0x74, 0x65, 0x73, 0x22, 0xdf, 0x02, 0x0a, 0x10, 0x53,
	...
	0x09, 0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x12, 0x30, 0x0a, 0x14, 0x64, 0x69, 0x61,
	0x67, 0x6e, 0x6f, 0x73, 0x74, 0x69, 0x63, 0x5f, 0x63, 0x65, 0x6e, 0x74, 0x72, 0x65, 0x5f, 0x69,
	0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x12, 0x64, 0x69, 0x61, 0x67, 0x6e, 0x6f, 0x73,
	0x74, 0x69, 0x63, 0x43, 0x65, 0x6e, 0x74, 0x72, 0x65, 0x49, 0x64, 0x12, 0x12, 0x0a, 0x04, 0x64,
	...
	0x69, 0x6d, 0x65, 0x12, 0x26, 0x0a, 0x09, 0x74, 0x65, 0x73, 0x74, 0x5f, 0x74, 0x79, 0x70, 0x65,
	0x18, 0x06, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x09, 0x2e, 0x54, 0x65, 0x73, 0x74, 0x54, 0x79, 0x70,
	0x65, 0x52, 0x08, 0x74, 0x65, 0x73, 0x74, 0x54, 0x79, 0x70, 0x65, 0x12, 0x2c, 0x0a, 0x0b, 0x74,
	0x65, 0x73, 0x74, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0e,
	0x32, 0x0b, 0x2e, 0x54, 0x65, 0x73, 0x74, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x0a, 0x74,
	0x65, 0x73, 0x74, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x19, 0x0a, 0x05, 0x6e, 0x6f, 0x74,
	0x65, 0x73, 0x18, 0x08, 0x20, 0x01, 0x28, 0x09, 0x48, 0x00, 0x52, 0x05, 0x6e, 0x6f, 0x74, 0x65,
	...
	0x41, 0x74, 0x42, 0x08, 0x0a, 0x06, 0x5f, 0x6e, 0x6f, 0x74, 0x65, 0x73, 0x22, 0x4e, 0x0a, 0x1d,
	0x4c, 0x69, 0x73, 0x74, 0x53, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x65, 0x64, 0x53, 0x65, 0x73,
	...
	,
	...
	0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x22, 0x74, 0x0a, 0x1e, 0x43, 0x61, 0x6e,
	0x63, 0x65, 0x6c, 0x53, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x65, 0x64, 0x53, 0x65, 0x73, 0x73,
	...
	0xa4, 0x01, 0x0a, 0x10, 0x53, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x65, 0x52, 0x65, 0x73, 0x70,
	...
	0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x2a, 0x55, 0x0a, 0x0a, 0x54, 0x65, 0x73, 0x74, 0x53, 0x74,
	...
	,
	...
	0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x65, 0x73, 0x12, 0x74, 0x0a, 0x12, 0x47, 0x65, 0x74, 0x53,
	0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x65, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x1b,
	0x2e, 0x47, 0x65, 0x74, 0x53, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x65, 0x64, 0x53, 0x65, 0x73,
	0x73, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1c, 0x2e, 0x47, 0x65,
	...
	,
	...
	,
	...
	0x6e, 0x2f, 0x73, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x65, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
...
var file_schedule_schedule_proto_goTypes = []interface{}{
	...
	(TestType)(0),           // 1: TestType
	(*ScheduleRequest)(nil), // 2: ScheduleRequest
	(*ListDiagnosticCentreSchedulesRequest)(nil),  // 3: ListDiagnosticCentreSchedulesRequest
	(*GetDiagnosticCentreScheduleRequest)(nil),    // 4: GetDiagnosticCentreScheduleRequest
	(*GetScheduledSessionRequest)(nil),            // 5: GetScheduledSessionRequest
	(*UpdateScheduledSessionRequest)(nil),         // 6: UpdateScheduledSessionRequest
	(*CancelScheduledSessionRequest)(nil),         // 7: CancelScheduledSessionRequest
	(*ListScheduledSessionsRequest)(nil),          // 8: ListScheduledSessionsRequest
	(*GetScheduledSessionResponse)(nil),           // 9: GetScheduledSessionResponse
	(*GetDiagnosticCentreScheduleResponse)(nil),   // 10: GetDiagnosticCentreScheduleResponse
	(*ScheduledSession)(nil),                      // 11: ScheduledSession
	(*ListScheduledSessionsResponse)(nil),         // 12: ListScheduledSessionsResponse
	(*ListDiagnosticCentreSchedulesResponse)(nil), // 13: ListDiagnosticCentreSchedulesResponse
	(*UpdateScheduledSessionResponse)(nil),        // 14: UpdateScheduledSessionResponse
	(*CancelScheduledSessionResponse)(nil),        // 15: CancelScheduledSessionResponse
	(*ScheduleResponse)(nil),                      // 16: ScheduleResponse
}
var file_schedule_schedule_proto_depIdxs = []int32{
	1,  // 0: ScheduleRequest.test_type:type_name -> TestType
	0,  // 1: ScheduleRequest.test_status:type_name -> TestStatus
	0,  // 2: ListDiagnosticCentreSchedulesRequest.test_status:type_name -> TestStatus
	1,  // 3: UpdateScheduledSessionRequest.test_type:type_name -> TestType
	0,  // 4: UpdateScheduledSessionRequest.test_status:type_name -> TestStatus
	0,  // 5: CancelScheduledSessionRequest.test_status:type_name -> TestStatus
	1,  // 6: GetScheduledSessionResponse.test_type:type_name -> TestType
	0,  // 7: GetScheduledSessionResponse.test_status:type_name -> TestStatus
	1,  // 8: GetDiagnosticCentreScheduleResponse.test_type:type_name -> TestType
	0,  // 9: GetDiagnosticCentreScheduleResponse.test_status:type_name -> TestStatus
	1,  // 10: ScheduledSession.test_type:type_name -> TestType
	0,  // 11: ScheduledSession.test_status:type_name -> TestStatus
	11, // 12: ListScheduledSessionsResponse.sessions:type_name -> ScheduledSession
	11, // 13: ListDiagnosticCentreSchedulesResponse.sessions:type_name -> ScheduledSession
	2,  // 14: ScheduleService.CreateScheduleSession:input_type -> ScheduleRequest
	5,  // 15: ScheduleService.GetScheduleSession:input_type -> GetScheduledSessionRequest
	6,  // 16: ScheduleService.UpdateScheduleSession:input_type -> UpdateScheduledSessionRequest
	7,  // 17: ScheduleService.CancelScheduleSession:input_type -> CancelScheduledSessionRequest
	8,  // 18: ScheduleService.ListScheduleSessions:input_type -> ListScheduledSessionsRequest
	3,  // 19: ScheduleService.ListDiagnosticCentreSchedules:input_type -> ListDiagnosticCentreSchedulesRequest
	4,  // 20: ScheduleService.GetDiagnosticCentreSchedule:input_type -> GetDiagnosticCentreScheduleRequest
	16, // 21: ScheduleService.CreateScheduleSession:output_type -> ScheduleResponse
	9,  // 22: ScheduleService.GetScheduleSession:output_type -> GetScheduledSessionResponse
	14, // 23: ScheduleService.UpdateScheduleSession:output_type -> UpdateScheduledSessionResponse
	15, // 24: ScheduleService.CancelScheduleSession:output_type -> CancelScheduledSessionResponse
	12, // 25: ScheduleService.ListScheduleSessions:output_type -> ListScheduledSessionsResponse
	13, // 26: ScheduleService.ListDiagnosticCentreSchedules:output_type -> ListDiagnosticCentreSchedulesResponse
	10, // 27: ScheduleService.GetDiagnosticCentreSchedule:output_type -> GetDiagnosticCentreScheduleResponse
