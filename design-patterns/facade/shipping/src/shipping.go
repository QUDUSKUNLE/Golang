...
func NewShipping(accountID string, productType product.ProductType) *Shipping {
...
func (shipping *Shipping) NewScheduleShipping(accountID, pickUpAddress, deliveryAddress, productType string) error {
