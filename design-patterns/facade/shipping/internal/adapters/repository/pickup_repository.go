...
func (database *PostgresRepository) QueryCreatePickUp(pickUp domain.PickUp) error {
...
func (database *PostgresRepository) QueryUpdatePickUp(pickUp domain.PickUp) error {
